...
import dev.benjaminguzman.listeners.DocumentUpdateHandler;
import dev.benjaminguzman.validators.InputRegexFilter;
...
public class NumberSpinner {
	...
	public JSpinner createJSpinner(
                ...
                Pattern regex,
                DocumentUpdateHandler.UpdateHandler updateHandler,
                Font font
        ) {
	 ...
	 */
	private PlainDocument createSpinnerDocument(
                final InputRegexFilter inputRegexFilter,
                final DocumentUpdateHandler.UpdateHandler updateHandler
        ) {
